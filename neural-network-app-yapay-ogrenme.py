...
girdi = array([[0,0,1], [1,1,1], [1,0,1]]) # 1 e 3 matris girişi

gercekSonuc = array([[0,1,1]]).T # T Transpose

sinapsAgirlik = array([[1.0,1.0,1.0]]).T

for tekrar in range(1000): # range sayısı artırılınca sinaps ağırlık oranı otimize olacak, hata oranı düşecek
